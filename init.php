...
if ( ! class_exists( 'Cmb' ) || ! isset( $_cmb ) ) {
...
function cmb_scripts( $hook ) {
  	if ( $hook == 'post.php' || $hook == 'post-new.php' || $hook == 'page-new.php' || $hook == 'page.php' ) {
		wp_enqueue_script( 'cmb-timepicker', CMB_META_BOX_URL . 'js/jquery.timePicker.min.js', array( 'jquery' ), '0.3', true );
		wp_enqueue_script( 'cmb-scripts', CMB_META_BOX_URL . 'js/cmb.js', array( 'jquery-ui-tabs', 'jquery-ui-datepicker', 'cmb-timepicker', 'media-upload', 'thickbox', 'farbtastic' ), '1.0.0', true );

		wp_enqueue_style( 'cmb-styles', CMB_META_BOX_URL . 'style.css', array( 'thickbox', 'farbtastic' ) );
  	}
}
